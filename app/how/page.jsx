...
const Home = () => {
  return (
    <div className='font-kokugo text-center text-2xl text-blue-950'>
      <h1 className='relative py-4 text-6xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 text-5xl animate-pulse'>■</label>使う時のアドバイス</h1>
      ...
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>表情モーフのこと</h2>
      ...
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>首まわりのこと</h2>
        <div className='text-left'>
      ...
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>腕のこと</h2>
        <div className='text-left'>
      ...
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>終わりに</h2>
        <div className='text-left'>
          ...
          　なんでこのページは英語版無いのかって？作者が英語できないからに決まってるじゃないですか。同様の理由で、きちんと細かい意図まで伝えられないので、英語版と日本語版で若干規約も変えてます。

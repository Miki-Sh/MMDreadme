const Home = () => {
  return (
    <div className='font-kokugo text-center text-2xl text-blue-950'>
      <h1 className='relative py-4 text-6xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 text-5xl animate-pulse'>■</label>利用規約</h1>
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>はじめに・注意事項</h2>
      ...
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>禁止事項</h2>
        <ul className='pl-8 text-left list-disc'>
      ...
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>水星の魔女のキャラクターに限る特例</h2>
      ...
      <h2 className='relative mt-16 mb-8 py-2 text-3xl bg-gradient-to-r from-blue-200 to-transparent border-l-2 border-b-2 border-blue-900'><label className='absolute left-2 bottom-1 animate-pulse'>■</label>更新履歴</h2>
        <ul className='pl-8 text-left list-disc'>
          <li>2024/1/1　配布開始</li>
        </ul>

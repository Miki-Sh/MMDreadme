...
const Footer = () => {
  return (
    <div className='xl:hidden flex justify-between mx-2 mb-2 text-xs text-gray-500'>
      ...
      <Link href='https://www.nicovideo.jp/user/21766196' className='md:flex items-center hover:text-blue-900 hover:bg-gradient-to-r from-blue-200 to-transparent'>
        <Image className='mx-4 animate-pulse' src='/nico.png' alt='youtube' height={30} width={30} /> 21766196
      </Link>
      {/* <p className='mt-8 ml-4'>YouTube</p> */}
      <Link href='https://www.youtube.com/@sadomaru111/videos' className='md:flex items-center hover:text-blue-900 hover:bg-gradient-to-r from-blue-200 to-transparent'>
      ...
      <Link href='https://twitter.com/rninx234' className='md:flex items-center hover:text-blue-900 hover:bg-gradient-to-r from-blue-200 to-transparent'>
      <Image className='mx-4 animate-pulse' src='/twitter.svg' alt='twitter' height={30} width={30} /> @rninx234
      </Link>
      {/* <Link href='https://twitter.com/rninx23' className='md:flex items-center hover:text-blue-900 hover:bg-gradient-to-r from-blue-200 to-transparent'> */}

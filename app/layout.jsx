        ...
        <div className='font-orbitron m-6 border-2 border-blue-500 shadow-lg'>
          <div className='hidden h-12 sm:flex justify-between items-center text-2xl text-blue-900'>
            <div>
              ...
              <Link className='hidden lg:inline hover:underline decoration-4 underline-offset-8 mx-8 hover:animate-pulse' href='/'>Japanese</Link>
              <Link className='hidden lg:inline hover:underline decoration-4 underline-offset-8 hover:animate-pulse' href='/rulesEn'>English</Link>
            </div>
          ...
          <div className='sm:m-4 sm:border-2 border-blue-500 sm:shadow-md'>
            <div className='md:m-3 md:border-2 border-blue-900'>
              <div className='flex m-4 p-2 sm:p-8 border-x-8 border-y-2 border-blue-900'>
                <div className='hidden lg:flex w-60 xl:w-80 flex-none mr-8 p-4 border-2 border-blue-900 shadow-xl animate-text-focus-in'>
                  <Sidebar />
                </div>
